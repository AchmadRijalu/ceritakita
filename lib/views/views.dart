...
import 'package:ceritakita/views/widgets/story_location_map.dart';
...
part 'stories_view.dart';
part 'add_story_view.dart';
part 'map_picker_view.dart';
part 'detail_story_view.dart';
